...
class _HomePageState extends State<HomePage> {
  ...
  void _refreshData() async {
    final data = await TaskDatabase.getItems();
    setState(() {
      myData = data;
      _isLoading = false;
    });
    ...
    return Scaffold(
      ...
      body: _isLoading
        ...
        itemBuilder: (context, index) => Card(
          color: CustomColors.thirdColorCustom, //index % 2 == 0 ? CustomColors.secondColorCustom : Colors.green[200],
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        child: Text(id == null ? 'Crear' : 'Editar'),
                      ),
                    ],
                  )
                ],
...
// Insert a new data to the database
  ...
  void deleteItem(int id) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text('Borrado Correctamente'), backgroundColor: CustomColors.secondColorCustom));
    _refreshData();
  }
